...
class OrderSystem:
    ...
    def make_order(self, order_id: int) -> None:
...
def main():
    ...
    order_system.make_order(2)
    order_system.remove_order(2)
    order_system.make_order(1818)
    order_system.make_order(8282)
    order_system.make_order(2255)
    order_system.make_order(6515)
    order_system.remove_order(1818)
    order_system.make_order(486)
